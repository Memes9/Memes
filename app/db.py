...
DEFAULT_SETTINGS: dict[str, Any] = {
    ...
    # ── قەرەبووکردنەوەی سپرێد (EA جێبەجێی دەکات) ────────────────────
    "spread_comp_enabled": True,
    "spread_extra_points": 0.0,     # پۆینتی زیادە لەسەر سپرێد
    "spread_cap_points": 0.0,       # زۆرترین بڕی زیادکراو (0 = بێ سنوور)
    "respect_stops_level": True,    # ڕێزگرتن لە کەمترین دووری بڕۆکەر

    # ── یاسای ٤: بەڕێوەبردنی داینامیکی مامەڵە ───────────────────────
    "progression_enabled": True,
    "tier1_trigger_pct": 30.0,      # لە چەند ٪ی TP دەست پێ بکات
    "tier1_lock_pct": 1.0,          # SL بخرێتە چەند ٪ی TP قازانج
    "tier2_trigger_pct": 50.0,
    "tier2_lock_pct": 3.0,
    "tier2_close_pct": 50.0,        # چەند ٪ی لۆت دابخرێت

    # ── جیاکردنەوەی لەیئاوتەکان ─────────────────────────────────────
    "magic_1m": 990001,
    "magic_3m": 990003,
